...
按 `assets/report-quality-checklist.md` 全部 11 项（A1-A6 + B1-B5）逐条勾选；跨市场报告额外勾选 C1-C4。

任何未通过项必须在报告 `## Meta` 段说明原因。严重 sanity 问题（B1-B5 任一 fail 且无合理解释）应**阻断报告产出**，回头补数据或修改结论，不要硬交付。
