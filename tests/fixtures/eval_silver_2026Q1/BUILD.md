...
- **Source data**: `data/silver` baseline plus collected-only official bronze overlay: FRED `2026-05-08`, Treasury yield curve `2026-05-07`, Treasury DTS `2026-05-07`, HKMA monetary base `2026-05-07`
...
Collected-only official overlays now included in `macro_daily.parquet` and
